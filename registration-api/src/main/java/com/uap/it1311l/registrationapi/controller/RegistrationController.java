...
public class RegistrationController {
	...
	public void update() {
		registrationRepo.updateSurveyEligibilityTag();
	}
	
	@DeleteMapping("event/registration/{AttendeeId}")
	public void delete(@PathVariable String AttendeeId) {
		registrationRepo.deleteByAttendeeId(AttendeeId);
	}
}
